...
> **Activity memory:** Every MCP tool call is appended to a project activity journal (`~/.ctx-agent/activity/<project-hash>.jsonl`), and each tool response includes an automatic summary of the last 5 actions.
